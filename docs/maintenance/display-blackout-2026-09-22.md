...
22:18:38 收到 Lid opened，22:18:43 Lid closed，22:18:45 Lid opened；
22:18:55 回读为 `open`。合盖状态已恢复，且本次开合事件能够正常上报。
这支持此前存在合盖状态异常的判断，但尚不能区分暂态传感器/磁性影响与固件或 ACPI 状态更新问题。
检查窗口内未出现新的睡眠；尚未完成长期黑屏复发观察，不能宣称永久修复。
未更改系统配置。
